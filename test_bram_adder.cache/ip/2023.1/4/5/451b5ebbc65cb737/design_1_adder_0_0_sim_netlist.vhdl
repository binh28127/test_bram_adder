...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fibo is
  ...
  signal \seq_i[1][31]_i_1_n_0\ : STD_LOGIC;
  signal \seq_i[1][31]_i_3_n_0\ : STD_LOGIC;
  signal \seq_i[1][31]_i_5_n_0\ : STD_LOGIC;
  signal \seq_i[1][31]_i_6_n_0\ : STD_LOGIC;
  signal \seq_i[1][31]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \address[10]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of seq_valid_i_i_1 : label is "soft_lutpair0";
begin
...
\address[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FFFFFF"
    )
        port map (
...
\seq_i[1][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\seq_i[1][31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
...
\seq_i[1][31]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
\seq_i[1][31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\seq_i[1][31]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\seq_i[1][31]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
\seq_i[1][31]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
seq_valid_i_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8808"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adder is
  ...
  attribute SOFT_HLUTNM of \address[9]_i_1\ : label is "soft_lutpair2";
  attribute ADDER_THRESHOLD : integer;
