...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adder is
  port (
    ...
    \address_reg[10]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adder is
  ...
  signal \^address_reg[10]_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \address[9]_i_2\ : label is "soft_lutpair1";
...
begin
  ...
  \address_reg[10]_0\ <= \^address_reg[10]_0\;
...
\address[10]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^q\(9),
      I1 => \^q\(7),
      I2 => \address[9]_i_3_n_0\,
      I3 => \^q\(6),
      I4 => \^q\(8),
      I5 => \^address_reg[10]_0\,
      O => p_1_in(10)
    );
...
\address[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adder
     port map (
      ...
      \address_reg[10]_0\ => \^bram_addr\(12),
      clk => \^clk\,
      rstn => rstn
    );
end STRUCTURE;
