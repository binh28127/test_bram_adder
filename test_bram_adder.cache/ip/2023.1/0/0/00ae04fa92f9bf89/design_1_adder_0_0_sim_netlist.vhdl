...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fibo is
  ...
  signal \seq_i[1][31]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \seq_i[1][31]_i_2\ : label is "soft_lutpair0";
...
\seq_i[1][31]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\seq_i[1][31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
seq_valid_i_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adder is
  ...
  attribute SOFT_HLUTNM of \address[10]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \address[10]_i_3\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \address[9]_i_1\ : label is "soft_lutpair3";
begin
  E(0) <= \^e\(0);
