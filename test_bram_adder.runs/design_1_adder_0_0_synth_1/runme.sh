...
HD_PWD='E:/zynq_beginner/test_bram_adder/test_bram_adder.runs/design_1_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adder_0_0.tcl
